...
//    assertEquals(collatzBounds.get(1), A03.collatz(1).count());
    assertEquals((long) collatzBounds.get(1), A03.collatz(1).count());
    assertEquals((long) collatzBounds.get(2), A03.collatz(2).count());
    assertEquals((long) collatzBounds.get(4), A03.collatz(4).count());
    assertEquals((long) collatzBounds.get(27), A03.collatz(27).count());
