...
public interface Deque<E> {
    ...
    /**
     * Returns a Stream of elements in stack-order
     *
     * @return Stream of elements in stack-order
     */
    Stream<E> stackStream();

    /**
     * Returns a Stream of elements in queue-order
     *
     * @return Stream of elements in queue-order
     */
    Stream<E> queueStream();
}
