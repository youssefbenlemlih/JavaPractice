...
public class MyDeque<E> implements Deque<E> {
    ...
    protected static class MyEntry<E> implements Serializable {

        private static final long serialVersionUID = -6218986102573506991L;
        ...
        public MyEntry<E> getBeforeHead() {
            return (next.equals(getHead())) ? this : next.getBeforeHead();
        }
        ...
        public int countUntilHead() {
            if (this.equals(getHead())) {
                return 1;
            }
            return next.countUntilHead() + 1;
        }

        public void writeObject(java.io.ObjectOutputStream out) throws IOException {
            // modCount not necessary due to MyEntry is immutable
//            out.defaultWriteObject();
    ...
    @Override
    public int size() {
        return bottom == null ? 0 : bottom.countUntilHead();
    }
